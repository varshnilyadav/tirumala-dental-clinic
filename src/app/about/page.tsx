...
<div className="page-wrapper">
                ...
                <div className="navbar_container">
                    ...
                    <div className="navbar-content_wrap">
                        <nav role="navigation" className="navbar_menu w-nav-menu">
                            ...
                            <a href="/about" aria-current="page" className="navbar_link w-inline-block w--current">
                                <div>About Us</div>
                            </a>
                                ...
                                <nav className="navbar-dropdown_list w-dropdown-list">
                                    <div className="navbar-dropdown_wrapper">
                                        <div className="navbar-dropdown_column">
                                            ...
                                            <a href="/about" data-animation="text-flip" aria-current="page" className="navbar-dropdown_link w-inline-block w--current">
                                                <div>About </div>
                                            </a>
            ...
            <main className="main-wrapper">
                                    ...
                                    <div className="about-hero_header">
                                        <div className="about-hero_content">
                                            <div className="margin-bottom margin-16px">
                                                <h1 hero-text-split="">Trusted Dental Experts, Decades of Care</h1>
                                            </div>
                                            <div className="margin-bottom margin-32px">
                                                <p data-w-id="2a63e096-69fe-d674-1e81-e817d23d0490" style={{ "opacity": "0" }} className="about-hero_para">At Tirumala, we combine compassion, innovation, and expertise to provide care you can trust. Your smile is our mission, and your comfort is our priority.</p>
                                            </div>
                                            <div data-w-id="2a63e096-69fe-d674-1e81-e817d23d0492" style={{ "opacity": "0" }} className="button-container">
                                        ...
                                        <div id="w-node-eb4bd012-3a82-28c4-da6a-dffff7cda011-965ec33d" className="about-hero_info">
                                            <div className="about-hero_info-item">
                                                <div className="about-hero_info-item_title">
                                                    <div className="counter_wrapper">
                                                        <div className="count-number">25+</div>
                                                    </div>
                                                </div>
                                                <div className="about-hero_info-item_text">Years of Dental Excellence</div>
                                            </div>
                                            <div className="about-hero_info-item">
                                                <div className="about-hero_info-item_title">
                                                    <div className="counter_wrapper">
                                                ...
                                                <div className="about-hero_info-item_text">Smiles Transformed </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div data-w-id="13f35a51-6f31-0fc5-cc8d-c0464d8ccc39" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="about-hero_image-wrap">
                                    <img className="about-hero_image" src="assets/img/gen_about-hero-image.jpg" alt="About image" style={{ "transform": "translate3d(0, 0, 0) scale3d(1.5, 1.5, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)" }} sizes="(max-width: 2320px) 100vw, 2320px" data-w-id="0eb5616a-32aa-f331-47e8-42e10447f18d" loading="lazy" srcSet="assets/img/gen_about-hero-image.jpg 500w, assets/img/gen_about-hero-image.jpg 800w, assets/img/gen_about-hero-image.jpg 1080w, assets/img/gen_about-hero-image.jpg 1600w, assets/img/gen_about-hero-image.jpg 2000w, assets/img/gen_about-hero-image.jpg 2320w"/>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="section_component">
                                <div className="about-story_content">
                                    <div className="content-align-center">
                                        <div data-w-id="a4c06514-eacc-f155-c8eb-f94540264326" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="margin-bottom margin-12px">
                                        ...
                                        <div className="margin-bottom margin-16px">
                                            <h2 data-w-id="6e1e9670-e608-ebb7-57d4-1a8a2967db15" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="heading-custom-h3">
                                                A Journey of Trusted Dental Care, Built on <span className="text-highlighted">Compassion and Innovation</span>
                                                , For more than two decades
                                            </h2>
                                        </div>
                                        <div className="margin-bottom margin-32px">
                                            <div className="about-story_para">
                                                <p data-w-id="57a25a7a-8c0b-4d81-59a1-9671c5b5cbe5" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="body-text-18px">Tirumala has been dedicated to improving lives through healthier smiles. From our humble beginnings to becoming a trusted name in dental care</p>
                                            </div>
                                        </div>
                                        <div data-w-id="bb2642b1-bfa3-9fb0-2c8b-1d550464ad27" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="button-container">
                                ...
                                <div className="story-images_list">
                                    <div id="w-node-_8219b02b-eaf7-ea81-91e1-723c676732d0-965ec33d" className="story-images_wrap">
                                        <img src="assets/img/gen_story-image-1.jpg" loading="lazy" alt="Story image" className="story_images"/>
                                    </div>
                                    <div id="w-node-_51690311-096a-fe57-6ab3-4620d5cde4a0-965ec33d" className="story-images_wrap is-odd">
                                        <img src="assets/img/gen_story-image-2.jpg" loading="lazy" alt="Story image" className="story_images"/>
                                    </div>
                                    <div id="w-node-_1f52818f-c54a-441c-f0ab-584a4015e415-965ec33d" className="story-images_wrap is-big">
                                        <img src="assets/img/gen_story-image-3.jpg" loading="lazy" sizes="100vw" srcSet="assets/img/gen_story-image-3.jpg 500w, assets/img/gen_story-image-3.jpg 640w" alt="Story image" className="story_images"/>
                                    </div>
                                    <div id="w-node-d4a9463e-8c87-eed9-77c9-1268cc89c355-965ec33d" className="story-images_wrap is-odd">
                                        <img src="assets/img/gen_story-image-4.jpg" loading="lazy" alt="Story image" className="story_images"/>
                                    </div>
                                    <div id="w-node-b5f89661-8dc7-6b5f-d5d7-680eeeed097b-965ec33d" className="story-images_wrap">
                                        <img src="assets/img/gen_story-image-5.jpg" loading="lazy" alt="Story image" className="story_images"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="section_success">
                    <div className="section-padding padding-120x120 top-none">
                        <div className="container">
                            <div className="section_component">
                                <div className="margin-bottom margin-56px">
                                    <div className="success-header">
                                        <div className="content-align-center">
                                            <div data-w-id="f0643ca4-def0-d25a-bdfb-36bb56724365" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="margin-bottom margin-12px">
                                                <div className="section_tag">
                                                    <div className="icon_wrap is-small">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 12 12" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                                            <path d="M12 5.45455H7.31455L10.6255 2.14364L9.85636 1.37455L6.54545 4.68545V0H5.45455V4.68545L2.14364 1.37455L1.37455 2.14364L4.68545 5.45455H0V6.54545H4.68545L1.37455 9.85636L2.14364 10.6255L5.45455 7.31455V12H6.54545V7.31455L9.85636 10.6255L10.6255 9.85636L7.31455 6.54545H12V5.45455Z" fill="currentColor"></path>
                                            ...
                                            <h2 data-w-id="7be24271-8823-a9fc-2237-06b13a4b788a" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="heading-custom-h3">
                                                Quick facts that highlight our journey, trust, and <span className="text-highlighted">community impact</span>
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                                <div className="success_list">
                                    <div id="w-node-_8379eabc-c9c1-5ee1-63dc-8d6049e453ed-965ec33d" className="success_card">
                                        <div className="success_overlay"></div>
                                        <div className="success-card_inner">
                                            <div className="success-card_title-wrap is-single">
                                                <h3 className="success-card_title">50K+ Patient Visits</h3>
                                            </div>
                                        </div>
                                        <div className="success-card_image-wrap">
                                            <img src="assets/img/69e041cad257c10b1176cd81_success-item-image-1.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69e041cad257c10b1176cd81_success-item-image-1-p-500.webp 500w, assets/img/69e041cad257c10b1176cd81_success-item-image-1.webp 747w" alt="Success image" className="success-card_image"/>
                                        </div>
                                    </div>
                                    <div className="success_card is-color-01">
                                        <div className="success-card_title-wrap">
                                            <h3 className="success-card_title">15+ Community Programs</h3>
                                        </div>
                                        <p className="text-color-light">Actively giving back through health camps &awareness drives.</p>
                                    </div>
                                    <div id="w-node-_68b6405b-edc4-3600-ae62-4a7d400cfd81-965ec33d" className="success_card">
                                        <div className="success_overlay is-bottom"></div>
                                        <div className="success-card_inner is-content-bottom">
                                            <div className="success-card_title-wrap is-single">
                                                <h3 className="success-card_title">4.9★ Google Rating</h3>
                                            </div>
                                        </div>
                                        <div className="success-card_image-wrap">
                                            <img src="assets/img/69e041cb0a159b45d163a9ea_success-item-image-2.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69e041cb0a159b45d163a9ea_success-item-image-2-p-500.webp 500w, assets/img/69e041cb0a159b45d163a9ea_success-item-image-2.webp 747w" alt="Success image" className="success-card_image"/>
                                        </div>
                                    </div>
                                    <div className="success_card is-color-02">
                                        <div className="success-card_title-wrap">
                                            <h3 className="success-card_title">12 Specialists on Board</h3>
                                        </div>
                                        <p>A multi-disciplinary team ready to care for every need.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section id="team-members" className="section_team">
                    <div className="section-padding padding-120x120">
                        <div className="container">
                            <div className="margin-bottom margin-56px">
                                <div className="team_header is-about">
                                    <div className="about-team_header-content">
                                        <div data-w-id="4525af4d-86e5-d634-9e8f-b502d5e98c72" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="margin-bottom margin-12px">
                                            <div className="section_tag">
                                                <div className="icon_wrap is-small">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 12 12" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                                        <path d="M12 5.45455H7.31455L10.6255 2.14364L9.85636 1.37455L6.54545 4.68545V0H5.45455V4.68545L2.14364 1.37455L1.37455 2.14364L4.68545 5.45455H0V6.54545H4.68545L1.37455 9.85636L2.14364 10.6255L5.45455 7.31455V12H6.54545V7.31455L9.85636 10.6255L10.6255 9.85636L7.31455 6.54545H12V5.45455Z" fill="currentColor"></path>
                                        ...
                                        <h2 data-w-id="4525af4d-86e5-d634-9e8f-b502d5e98c75" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }}>
                                            Superheroes Behind the <span className="text-highlighted">Dental Care</span>
                                        </h2>
                                    </div>
                                    <div id="w-node-_7ca7d48a-77c9-2b74-04de-6d116d75d6cf-965ec33d" className="about-team_para-wrap">
                                        <p data-w-id="bcbebfde-cdd4-c91d-c8fe-58183c27775a" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="about-team_para">Each member of our clinical staff is not only highly qualified but deeply passionate about helping patients achieve healthier.</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div role="list" className="team_list w-dyn-items">
                                    <div role="listitem" className="w-dyn-item">
                                        <div className="team_item">
                                            <a aria-label="doctor&#x27;s profile" href="/about" className="team-image_wrap w-inline-block">
                                                <div className="image-animation-trigger">
                                                    <div className="image-animation-scale">
                                                        <img src="assets/img/gen_team-image-6.jpg" loading="lazy" alt="" className="team_image"/>
                                                    </div>
                                                </div>
                                            </a>
                                            <div className="team-item_content">
                                                ...
                                                <div className="team-menuber_info">
                                                    ...
                                                    <div className="team-menuber_social">
                                                        <a aria-label="doctor&#x27;s social" href="http://instagram.com/" className="team-menuber_social-item w-inline-block">
                                                        ...
                                                        <a aria-label="doctor&#x27;s social" href="http://twitter.com/" className="team-menuber_social-item w-inline-block">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                    ...
                                    <div role="listitem" className="w-dyn-item">
                                        <div className="team_item">
                                            <a aria-label="doctor&#x27;s profile" href="/about" className="team-image_wrap w-inline-block">
                                                <div className="image-animation-trigger">
                                                    <div className="image-animation-scale">
                                                        <img src="assets/img/gen_team-image-5.jpg" loading="lazy" alt="" sizes="100vw" srcSet="assets/img/gen_team-image-5.jpg 500w, assets/img/gen_team-image-5.jpg 742w" className="team_image"/>
                                                    </div>
                                                </div>
                                            </a>
                                            <div className="team-item_content">
                                    ...
                                    <div role="listitem" className="w-dyn-item">
                                        <div className="team_item">
                                            <a aria-label="doctor&#x27;s profile" href="/about" className="team-image_wrap w-inline-block">
                                                <div className="image-animation-trigger">
                                                    <div className="image-animation-scale">
                                                        <img src="assets/img/gen_team-image-4.jpg" loading="lazy" alt="" sizes="100vw" srcSet="assets/img/gen_team-image-4.jpg 500w, assets/img/gen_team-image-4.jpg 748w" className="team_image"/>
                                                    </div>
                                                </div>
                                            </a>
                                            <div className="team-item_content">
                                    ...
                                    <div role="listitem" className="w-dyn-item">
                                        <div className="team_item">
                                            <a aria-label="doctor&#x27;s profile" href="/about" className="team-image_wrap w-inline-block">
                                                <div className="image-animation-trigger">
                                                    <div className="image-animation-scale">
                                                        <img src="assets/img/gen_team-image-3.jpg" loading="lazy" alt="" sizes="100vw" srcSet="assets/img/gen_team-image-3.jpg 500w, assets/img/gen_team-image-3.jpg 746w" className="team_image"/>
                                                    </div>
                                                </div>
                                            </a>
                                            <div className="team-item_content">
                                                <a aria-label="doctor&#x27;s profile" href="/about" className="team-menmber_wrap w-inline-block">
                                                    <h3 className="team-menmber_name">Dr. Thumu Sai Kumar</h3>
                                                </a>
                                                <div className="team-menuber_info">
                                                    <p className="team-menuber_designation">Dentist</p>
                                                    <div className="team-menuber_social">
                                                        <a aria-label="doctor&#x27;s social" href="http://instagram.com/" className="team-menuber_social-item w-inline-block">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                                                <path d="M13.0287 2.00098C14.1541 2.00284 14.7244 2.0088 15.2172 2.02347L15.4113 2.02981C15.6355 2.03778 15.8567 2.04778 16.1234 2.06028C17.1875 2.10945 17.9134 2.27778 18.5509 2.52528C19.21 2.77945 19.7667 3.12278 20.3225 3.67862C20.8775 4.23445 21.2209 4.79278 21.4759 5.45028C21.7225 6.08695 21.8909 6.81362 21.9409 7.87778C21.9528 8.14445 21.9624 8.36565 21.9703 8.58989L21.9766 8.78398C21.9912 9.27672 21.9979 9.8471 22 10.9725L22.0008 11.7181C22.0009 11.8092 22.0009 11.9032 22.0009 12.0002L22.0008 12.2823L22.0002 13.028C21.9983 14.1534 21.9924 14.7238 21.9777 15.2165L21.9713 15.4106C21.9634 15.6349 21.9534 15.8561 21.9409 16.1227C21.8917 17.1869 21.7225 17.9127 21.4759 18.5502C21.2217 19.2094 20.8775 19.7661 20.3225 20.3219C19.7667 20.8769 19.2075 21.2202 18.5509 21.4752C17.9134 21.7219 17.1875 21.8902 16.1234 21.9402C15.8567 21.9521 15.6355 21.9618 15.4113 21.9696L15.2172 21.9759C14.7244 21.9906 14.1541 21.9972 13.0287 21.9994L12.283 22.0002C12.1919 22.0002 12.0979 22.0002 12.0009 22.0002H11.7188L10.9731 21.9995C9.84771 21.9977 9.27733 21.9917 8.78458 21.977L8.5905 21.9707C8.36625 21.9627 8.14505 21.9527 7.87839 21.9402C6.81422 21.8911 6.08922 21.7219 5.45089 21.4752C4.79255 21.2211 4.23505 20.8769 3.67922 20.3219C3.12339 19.7661 2.78089 19.2069 2.52589 18.5502C2.27839 17.9127 2.11089 17.1869 2.06089 16.1227C2.04901 15.8561 2.03932 15.6349 2.03147 15.4106L2.02518 15.2165C2.01055 14.7238 2.00388 14.1534 2.00172 13.028L2.00159 10.9725C2.00345 9.8471 2.0094 9.27672 2.02407 8.78398L2.03042 8.58989C2.03839 8.36565 2.04839 8.14445 2.06089 7.87778C2.11005 6.81278 2.27839 6.08778 2.52589 5.45028C2.78005 4.79195 3.12339 4.23445 3.67922 3.67862C4.23505 3.12278 4.79339 2.78028 5.45089 2.52528C6.08839 2.27778 6.81339 2.11028 7.87839 2.06028C8.14505 2.04841 8.36625 2.03872 8.5905 2.03087L8.78458 2.02458C9.27733 2.00994 9.84771 2.00327 10.9731 2.00111L13.0287 2.00098ZM12.0009 7.00028C9.23799 7.00028 7.00089 9.23981 7.00089 12.0002C7.00089 14.7631 9.24042 17.0002 12.0009 17.0002C14.7638 17.0002 17.0009 14.7607 17.0009 12.0002C17.0009 9.23738 14.7613 7.00028 12.0009 7.00028ZM12.0009 9.00028C13.6578 9.00028 15.0009 10.3429 15.0009 12.0002C15.0009 13.6571 13.6582 15.0002 12.0009 15.0002C10.344 15.0002 9.00089 13.6576 9.00089 12.0002C9.00089 10.3433 10.3435 9.00028 12.0009 9.00028ZM17.2509 5.50028C16.5616 5.50028 16.0009 6.06019 16.0009 6.74943C16.0009 7.43868 16.5608 7.99945 17.2509 7.99945C17.9401 7.99945 18.5009 7.43955 18.5009 6.74943C18.5009 6.06019 17.9392 5.49942 17.2509 5.50028Z" fill="currentColor"></path>
                                    ...
                                    <div role="listitem" className="w-dyn-item">
                                        <div className="team_item">
                                            <a aria-label="doctor&#x27;s profile" href="/about" className="team-image_wrap w-inline-block">
                                                <div className="image-animation-trigger">
                                                    <div className="image-animation-scale">
                                                        <img src="assets/img/gen_team-image-2.jpg" loading="lazy" alt="" sizes="100vw" srcSet="assets/img/gen_team-image-2.jpg 500w, assets/img/gen_team-image-2.jpg 746w" className="team_image"/>
                                                    </div>
                                                </div>
                                            </a>
                                            <div className="team-item_content">
                                                <a aria-label="doctor&#x27;s profile" href="/about" className="team-menmber_wrap w-inline-block">
                                                    <h3 className="team-menmber_name">Dr. Thumu Bharathi</h3>
                                                </a>
                                                <div className="team-menuber_info">
                                                    <p className="team-menuber_designation">Conservative Endodontist</p>
                                                    <div className="team-menuber_social">
                                                        <a aria-label="doctor&#x27;s social" href="http://instagram.com/" className="team-menuber_social-item w-inline-block">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                                                <path d="M13.0287 2.00098C14.1541 2.00284 14.7244 2.0088 15.2172 2.02347L15.4113 2.02981C15.6355 2.03778 15.8567 2.04778 16.1234 2.06028C17.1875 2.10945 17.9134 2.27778 18.5509 2.52528C19.21 2.77945 19.7667 3.12278 20.3225 3.67862C20.8775 4.23445 21.2209 4.79278 21.4759 5.45028C21.7225 6.08695 21.8909 6.81362 21.9409 7.87778C21.9528 8.14445 21.9624 8.36565 21.9703 8.58989L21.9766 8.78398C21.9912 9.27672 21.9979 9.8471 22 10.9725L22.0008 11.7181C22.0009 11.8092 22.0009 11.9032 22.0009 12.0002L22.0008 12.2823L22.0002 13.028C21.9983 14.1534 21.9924 14.7238 21.9777 15.2165L21.9713 15.4106C21.9634 15.6349 21.9534 15.8561 21.9409 16.1227C21.8917 17.1869 21.7225 17.9127 21.4759 18.5502C21.2217 19.2094 20.8775 19.7661 20.3225 20.3219C19.7667 20.8769 19.2075 21.2202 18.5509 21.4752C17.9134 21.7219 17.1875 21.8902 16.1234 21.9402C15.8567 21.9521 15.6355 21.9618 15.4113 21.9696L15.2172 21.9759C14.7244 21.9906 14.1541 21.9972 13.0287 21.9994L12.283 22.0002C12.1919 22.0002 12.0979 22.0002 12.0009 22.0002H11.7188L10.9731 21.9995C9.84771 21.9977 9.27733 21.9917 8.78458 21.977L8.5905 21.9707C8.36625 21.9627 8.14505 21.9527 7.87839 21.9402C6.81422 21.8911 6.08922 21.7219 5.45089 21.4752C4.79255 21.2211 4.23505 20.8769 3.67922 20.3219C3.12339 19.7661 2.78089 19.2069 2.52589 18.5502C2.27839 17.9127 2.11089 17.1869 2.06089 16.1227C2.04901 15.8561 2.03932 15.6349 2.03147 15.4106L2.02518 15.2165C2.01055 14.7238 2.00388 14.1534 2.00172 13.028L2.00159 10.9725C2.00345 9.8471 2.0094 9.27672 2.02407 8.78398L2.03042 8.58989C2.03839 8.36565 2.04839 8.14445 2.06089 7.87778C2.11005 6.81278 2.27839 6.08778 2.52589 5.45028C2.78005 4.79195 3.12339 4.23445 3.67922 3.67862C4.23505 3.12278 4.79339 2.78028 5.45089 2.52528C6.08839 2.27778 6.81339 2.11028 7.87839 2.06028C8.14505 2.04841 8.36625 2.03872 8.5905 2.03087L8.78458 2.02458C9.27733 2.00994 9.84771 2.00327 10.9731 2.00111L13.0287 2.00098ZM12.0009 7.00028C9.23799 7.00028 7.00089 9.23981 7.00089 12.0002C7.00089 14.7631 9.24042 17.0002 12.0009 17.0002C14.7638 17.0002 17.0009 14.7607 17.0009 12.0002C17.0009 9.23738 14.7613 7.00028 12.0009 7.00028ZM12.0009 9.00028C13.6578 9.00028 15.0009 10.3429 15.0009 12.0002C15.0009 13.6571 13.6582 15.0002 12.0009 15.0002C10.344 15.0002 9.00089 13.6576 9.00089 12.0002C9.00089 10.3433 10.3435 9.00028 12.0009 9.00028ZM17.2509 5.50028C16.5616 5.50028 16.0009 6.06019 16.0009 6.74943C16.0009 7.43868 16.5608 7.99945 17.2509 7.99945C17.9401 7.99945 18.5009 7.43955 18.5009 6.74943C18.5009 6.06019 17.9392 5.49942 17.2509 5.50028Z" fill="currentColor"></path>
                                    ...
                                    <div role="listitem" className="w-dyn-item">
                                        <div className="team_item">
                                            <a aria-label="doctor&#x27;s profile" href="/about" className="team-image_wrap w-inline-block">
                                                <div className="image-animation-trigger">
                                                    <div className="image-animation-scale">
                                                        <img src="assets/img/gen_team-image-1.jpg" loading="lazy" alt="" sizes="100vw" srcSet="assets/img/gen_team-image-1.jpg 500w, assets/img/gen_team-image-1.jpg 748w" className="team_image"/>
                                                    </div>
                                                </div>
                                            </a>
                                            <div className="team-item_content">
                ...
                <section className="section_job">
                    <div className="section-padding padding-120x120 bottom-none">
                        <div className="container">
                            <div className="section_component">
                                <div className="margin-bottom margin-56px">
                                    <div className="job_header">
                                        <div data-w-id="f95b58f8-ba8b-0d31-78b9-c4b1096adf3b" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="job-header_tag">
                                            <div className="section_tag">
                                                <div className="icon_wrap is-small">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 12 12" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                                        <path d="M12 5.45455H7.31455L10.6255 2.14364L9.85636 1.37455L6.54545 4.68545V0H5.45455V4.68545L2.14364 1.37455L1.37455 2.14364L4.68545 5.45455H0V6.54545H4.68545L1.37455 9.85636L2.14364 10.6255L5.45455 7.31455V12H6.54545V7.31455L9.85636 10.6255L10.6255 9.85636L7.31455 6.54545H12V5.45455Z" fill="currentColor"></path>
                                        ...
                                        <h2 data-w-id="098ed022-441d-c2a3-8fdb-804d6133d6f6" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }}>
                                            Your <span className="text-highlighted">Next Career</span>
                                            Starts Here
                                        </h2>
                                    </div>
                                </div>
                    ...
                    <div data-w-id="33779dec-7d1e-bf96-aaeb-09d43429d0d9" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="job-images_list">
                        <div className="marquee_list">
                            <div className="marquee_item">
                                <div className="marquee-item_inner">
                                    <div className="job-image_wrap">
                                        <img src="assets/img/69e04a22703503e46c521e06_job-image-1.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69e04a22703503e46c521e06_job-image-1-p-500.webp 500w, assets/img/69e04a22703503e46c521e06_job-image-1.webp 740w" alt="Job image" className="job_image"/>
                                    </div>
                                    <div className="job-image_wrap">
                                        <img src="assets/img/69e04a224235a048c0681b59_job-image-2.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69e04a224235a048c0681b59_job-image-2-p-500.webp 500w, assets/img/69e04a224235a048c0681b59_job-image-2.webp 740w" alt="Job image" className="job_image"/>
                                    </div>
                                    <div className="job-image_wrap">
                                        <img src="assets/img/69e04a22189ced06cbe03360_job-image-3.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69e04a22189ced06cbe03360_job-image-3-p-500.webp 500w, assets/img/69e04a22189ced06cbe03360_job-image-3.webp 740w" alt="Job image" className="job_image"/>
                                    </div>
                                    <div className="job-image_wrap">
                                        <img src="assets/img/69e04a22dc5ccb1bff991531_job-image-4.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69e04a22dc5ccb1bff991531_job-image-4-p-500.webp 500w, assets/img/69e04a22dc5ccb1bff991531_job-image-4.webp 740w" alt="Job image" className="job_image"/>
                                    </div>
                                    <div className="job-image_wrap">
                                        <img src="assets/img/69e04a223f433596d3d0395e_job-image-5.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69e04a223f433596d3d0395e_job-image-5-p-500.webp 500w, assets/img/69e04a223f433596d3d0395e_job-image-5.webp 740w" alt="Job image" className="job_image"/>
                                    </div>
                                </div>
                                <div className="marquee-item_inner">
                                    <div className="job-image_wrap">
                            ...
                            <div className="section_component">
                                <div className="job_list">
                                    <div className="job_item">
                                        <div className="job-item_header">
                                            <div className="job-item_header-content">
                                                <div className="job-item_header-tag">
                                                    <div>Full-Time</div>
                                                </div>
                                                <h3 className="job-item_title">Dentist</h3>
                                            </div>
                                            <div className="job-item_header-button">
                                                <a data-wf--button-primary--variant="light" href="https://docs.google.com/forms/" target="_blank" className="button_primary w-variant-62db4792-8717-dbe8-e811-0d36eb02f9ec w-inline-block">
                                                    <div className="button_inner">
                                                        <div className="button-text_wrap">
                                                            <div className="button_text">Apply Now</div>
                                                        </div>
                                        ...
                                        <div className="job-description_wrap">
                                            <p className="job_description">Provide exceptional dental care using modern techniques and technologies. Build lasting relationships with patients while promoting oral health and wellness.</p>
                                        </div>
                                        <div className="job-item_info">
                                            <div className="job-item_info-box">
                                                <div className="job-item_info-item">
                                                    <div className="job-item_info-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 16 16" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                                            <path d="M8.00049 0.833008C10.5511 0.833008 12.9847 2.34182 14.0034 4.72266C14.9502 6.93589 14.4388 8.82397 13.3716 10.4404C12.4864 11.7812 11.1911 12.9752 10.0259 14.0488C9.81901 14.2394 9.61604 14.4262 9.42041 14.6094C9.03706 14.9683 8.52741 15.167 8.00049 15.167C7.47366 15.167 6.96485 14.9682 6.58154 14.6094L6.57959 14.6084C6.37263 14.4135 6.15768 14.2139 5.93799 14.0107C4.78532 12.9448 3.50734 11.7633 2.63135 10.4395C1.56294 8.82469 1.04963 6.93854 1.99756 4.72266C3.01623 2.3418 5.44989 0.833074 8.00049 0.833008ZM8.00049 1.83301C5.82774 1.83307 3.77009 3.12353 2.91748 5.11621C2.13514 6.94501 2.53049 8.47482 3.46533 9.8877C4.26837 11.1013 5.4384 12.1853 6.59229 13.2539C6.81802 13.4629 7.04352 13.6711 7.26514 13.8799C7.45996 14.0621 7.72332 14.167 8.00049 14.167C8.27791 14.167 8.54191 14.0623 8.73682 13.8799C8.94485 13.6851 9.15595 13.4903 9.36768 13.2949C10.5365 12.2165 11.7259 11.1191 12.5376 9.88965C13.4715 8.47499 13.8658 6.94266 13.0845 5.11621C12.2319 3.12335 10.1734 1.83301 8.00049 1.83301ZM7.99951 4.5C9.56421 4.5 10.8333 5.76835 10.8335 7.33301C10.8335 8.89781 9.56432 10.167 7.99951 10.167C6.43491 10.1668 5.1665 8.89767 5.1665 7.33301C5.16668 5.7685 6.43502 4.50024 7.99951 4.5ZM7.99951 5.5C6.9873 5.50024 6.16668 6.32078 6.1665 7.33301C6.1665 8.34538 6.98719 9.16675 7.99951 9.16699C9.01203 9.16699 9.8335 8.34553 9.8335 7.33301C9.83332 6.32064 9.01193 5.5 7.99951 5.5Z" fill="currentColor"></path>
                                                        </svg>
                                                    </div>
                                                    <div className="job-item_info-text">Adilabad, Telangana</div>
                                                </div>
                                                <div className="job-item_info-divider"></div>
                                                <div className="job-item_info-text">$85/hr</div>
                                            </div>
                                            <div className="job-item_info-badge">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 32 32" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                                    <path d="M6.66536 2.66406H25.332C26.0684 2.66406 26.6654 3.26102 26.6654 3.9974V29.5218C26.6654 29.8899 26.3668 30.1886 25.9987 30.1886C25.8735 30.1886 25.7507 30.1531 25.6446 30.0866L15.9987 24.0391L6.35282 30.0866C6.04087 30.2822 5.62944 30.1879 5.43386 29.8759C5.36732 29.7698 5.33203 29.6471 5.33203 29.5218V3.9974C5.33203 3.26102 5.92899 2.66406 6.66536 2.66406ZM23.9987 5.33073H7.9987V25.9073L15.9987 20.8917L23.9987 25.9073V5.33073Z" fill="currentColor"></path>
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="job_item">
                                        <div className="job-item_header">
                                            <div className="job-item_header-content">
                                                ...
                                                <h3 className="job-item_title">Dental Assistant</h3>
                                            </div>
                                            <div>
                                                <a data-wf--button-primary--variant="light" href="https://docs.google.com/forms/" target="_blank" className="button_primary w-variant-62db4792-8717-dbe8-e811-0d36eb02f9ec w-inline-block">
                                                    <div className="button_inner">
                                        ...
                                        <div className="job-description_wrap">
                                            <p className="job_description">Assist dentists during procedures while ensuring patient comfort and safety. Manage clinical tools and support smooth, efficient operations in the treatment room.</p>
                                        </div>
                                        <div className="job-item_info">
                                            <div className="job-item_info-box">
                                                <div className="job-item_info-item">
                                    ...
                                    <div className="job_item">
                                        <div className="job-item_header">
                                            <div className="job-item_header-content">
                                                ...
                                                <h3 className="job-item_title">Receptionist / Front Desk Officer</h3>
                                            </div>
                                            <div>
                                                <a data-wf--button-primary--variant="light" href="https://docs.google.com/forms/" target="_blank" className="button_primary w-variant-62db4792-8717-dbe8-e811-0d36eb02f9ec w-inline-block">
                                                    <div className="button_inner">
                                        ...
                                        <div className="job-description_wrap">
                                            <p className="job_description">Be the welcoming face of our clinic, managing appointments and patient inquiries. Ensure smooth daily operations while providing a friendly and professional experience.</p>
                                        </div>
                                        <div className="job-item_info">
                                            <div className="job-item_info-box">
                                                <div className="job-item_info-item">
                    ...
                    <div className="job-overlay_wrap">
                        <div className="job_overlay is-top-right"></div>
                        <div className="job_overlay is-bottom-right"></div>
                    </div>
                </section>
                <section className="section_awards">
                    <div className="section-padding padding-120x120">
                        <div className="container">
                            <div className="section_component">
                                <div data-current="Tab 1" data-easing="ease" data-duration-in="300" data-duration-out="100" className="awards_tabs w-tabs">
                                    <div data-w-id="178e67b7-2922-e9a2-969c-2e531e642587" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="awards-tabs_menu w-tab-menu">
                                        <a data-w-tab="Tab 1" className="awards-tabs_link w-inline-block w-tab-link w--current">
                                            <div className="awards-tabs_link-image_wrap">
                                                <img src="assets/img/69f603fd81d37039ab4ee292_awards-image-1.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69f603fd81d37039ab4ee292_awards-image-1-p-500.webp 500w, assets/img/69f603fd81d37039ab4ee292_awards-image-1-p-800.webp 800w, assets/img/69f603fd81d37039ab4ee292_awards-image-1.webp 960w" alt="Awards image" className="awards-tabs_link-image"/>
                                            </div>
                                            <div className="awards-tabs_link-text">Best Dental Clinic Award</div>
                                        </a>
                                        <a data-w-tab="Tab 2" className="awards-tabs_link w-inline-block w-tab-link">
                                            <div className="awards-tabs_link-image_wrap">
                                                <img src="assets/img/69f603fd71d990572ddc9bf5_awards-image-2.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69f603fd71d990572ddc9bf5_awards-image-2-p-500.webp 500w, assets/img/69f603fd71d990572ddc9bf5_awards-image-2-p-800.webp 800w, assets/img/69f603fd71d990572ddc9bf5_awards-image-2.webp 960w" alt="Awards image" className="awards-tabs_link-image"/>
                                            </div>
                                            <div className="awards-tabs_link-text">Excellence in Patient Care</div>
                                        </a>
                                        <a data-w-tab="Tab 3" className="awards-tabs_link w-inline-block w-tab-link">
                                            <div className="awards-tabs_link-image_wrap">
                                                <img src="assets/img/69f603fd5f23464634867a35_awards-image-3.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69f603fd5f23464634867a35_awards-image-3-p-500.webp 500w, assets/img/69f603fd5f23464634867a35_awards-image-3-p-800.webp 800w, assets/img/69f603fd5f23464634867a35_awards-image-3.webp 960w" alt="Awards image" className="awards-tabs_link-image"/>
                                            </div>
                                            <div className="awards-tabs_link-text">Top Cosmetic Dentistry </div>
                                        </a>
                                        <a data-w-tab="Tab 4" className="awards-tabs_link w-inline-block w-tab-link">
                                            <div className="awards-tabs_link-image_wrap">
                                                <img src="assets/img/69f603fd8e5ebbe23b11d3be_awards-image-4.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69f603fd8e5ebbe23b11d3be_awards-image-4-p-500.webp 500w, assets/img/69f603fd8e5ebbe23b11d3be_awards-image-4-p-800.webp 800w, assets/img/69f603fd8e5ebbe23b11d3be_awards-image-4.webp 960w" alt="Awards image" className="awards-tabs_link-image"/>
                                            </div>
                                            <div className="awards-tabs_link-text">Certified Invisalign </div>
                                        </a>
                                    </div>
                                    <div data-w-id="178e67b7-2922-e9a2-969c-2e531e642591" style={{ "transform": "translate3d(0, 25%, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)", "opacity": "0" }} className="awards-tabs_content w-tab-content">
                                        <div data-w-tab="Tab 1" className="w-tab-pane w--tab-active">
                                            <div className="awards-tabs_pane-inner">
                                                <div className="awards-tabs_pane-content">
                                                    <div className="awards-tabs_pane-content_header">
                                                        ...
                                                        <div className="margin-bottom margin-16px">
                                                            <h2>
                                                                Honored for <span className="text-highlighted">Excellence </span>
                                                                in Dental Care
                                                            </h2>
                                                        </div>
                                                        <p className="body-text-18px">Our commitment to innovation, patient safety, and compassionate care has been recognized by industry leaders and trusted organizations worldwide.</p>
                                                    </div>
                                                    <div className="awards-tabs_pane-feature">
                                                        <div className="awards-tabs_pane-feature_item">
                                                            <div className="awards-tabs_pane-feature_item-icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 16 16" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                                                    <path d="M16 7.27273H9.75273L14.1673 2.85818L13.1418 1.83273L8.72727 6.24727V0H7.27273V6.24727L2.85818 1.83273L1.83273 2.85818L6.24727 7.27273H0V8.72727H6.24727L1.83273 13.1418L2.85818 14.1673L7.27273 9.75273V16H8.72727V9.75273L13.1418 14.1673L14.1673 13.1418L9.75273 8.72727H16V7.27273Z" fill="#24A3B1"></path>
                                                                </svg>
                                                            </div>
                                                        ...
                                                        <div className="awards-tabs_pane-feature_item">
                                                            ...
                                                            <div>Excellence That Speaks Through Recognition.</div>
                                                        </div>
                                                        <div className="awards-tabs_pane-feature_item">
                                                            <div className="awards-tabs_pane-feature_item-icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 16 16" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                                            ...
                                                            <div>Celebrating Milestones of Dedication, Innovation, and Trust.</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="awards-tabs_pane-image">
                                                    <div className="awards-tabs_image-wrap">
                                                        <img src="assets/img/69f603fd81d37039ab4ee292_awards-image-1.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69f603fd81d37039ab4ee292_awards-image-1-p-500.webp 500w, assets/img/69f603fd81d37039ab4ee292_awards-image-1-p-800.webp 800w, assets/img/69f603fd81d37039ab4ee292_awards-image-1.webp 960w" alt="Awards image" className="awards-tabs_image"/>
                                                    </div>
                                                    <div className="awards-tabs_image-content">
                                                        <div className="awards-tabs_image-title_wrap">
                                                            <h3 className="awards-tabs_image-content_title">National Dental Association (2022)</h3>
                                                        </div>
                                                    </div>
                                                    <div className="awards-tabs_image-overlay"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div data-w-tab="Tab 2" className="w-tab-pane">
                                            <div className="awards-tabs_pane-inner">
                                                ...
                                                <div className="awards-tabs_pane-image">
                                                    <div className="awards-tabs_image-wrap">
                                                        <img src="assets/img/69f603fd71d990572ddc9bf5_awards-image-2.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69f603fd71d990572ddc9bf5_awards-image-2-p-500.webp 500w, assets/img/69f603fd71d990572ddc9bf5_awards-image-2-p-800.webp 800w, assets/img/69f603fd71d990572ddc9bf5_awards-image-2.webp 960w" alt="Awards image" className="awards-tabs_image"/>
                                                    </div>
                                                    <div className="awards-tabs_image-content">
                                                        <div className="awards-tabs_image-title_wrap">
                                                            <h3 className="awards-tabs_image-content_title">National Dental Association (2023)</h3>
                                                        </div>
                                                    </div>
                                                    <div className="awards-tabs_image-overlay"></div>
                                                </div>
                                        ...
                                        <div data-w-tab="Tab 3" className="w-tab-pane">
                                            <div className="awards-tabs_pane-inner">
                                                ...
                                                <div className="awards-tabs_pane-image">
                                                    <div className="awards-tabs_image-wrap">
                                                        <img src="assets/img/69f603fd5f23464634867a35_awards-image-3.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69f603fd5f23464634867a35_awards-image-3-p-500.webp 500w, assets/img/69f603fd5f23464634867a35_awards-image-3-p-800.webp 800w, assets/img/69f603fd5f23464634867a35_awards-image-3.webp 960w" alt="Awards image" className="awards-tabs_image"/>
                                                    </div>
                                                    <div className="awards-tabs_image-content">
                                                        <div className="awards-tabs_image-title_wrap">
                                                            <h3 className="awards-tabs_image-content_title">National Dental Association (2024)</h3>
                                                        </div>
                                                    </div>
                                                    <div className="awards-tabs_image-overlay"></div>
                                                </div>
                                        ...
                                        <div data-w-tab="Tab 4" className="w-tab-pane">
                                            <div className="awards-tabs_pane-inner">
                                                ...
                                                <div className="awards-tabs_pane-image">
                                                    <div className="awards-tabs_image-wrap">
                                                        <img src="assets/img/69f603fd8e5ebbe23b11d3be_awards-image-4.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69f603fd8e5ebbe23b11d3be_awards-image-4-p-500.webp 500w, assets/img/69f603fd8e5ebbe23b11d3be_awards-image-4-p-800.webp 800w, assets/img/69f603fd8e5ebbe23b11d3be_awards-image-4.webp 960w" alt="Awards image" className="awards-tabs_image"/>
                                                    </div>
                                                    <div className="awards-tabs_image-content">
                                                        <div className="awards-tabs_image-title_wrap">
                                                            <h3 className="awards-tabs_image-content_title">National Dental Association (2025)</h3>
                                                        </div>
                                                    </div>
                                                    <div className="awards-tabs_image-overlay"></div>
                                                </div>
                ...
                <section className="section_location">
                            ...
                            <div className="section_component">
                                <div className="margin-bottom margin-56px">
                                    <div className="location_header">
                                        <div data-w-id="a313081b-5ff0-9d58-ad3e-7267b0dcf911" className="margin-bottom margin-12px">
                                            <div className="section_tag">
                                                <div className="icon_wrap is-small">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 12 12" fill="none" vector-effect="non-scaling-stroke" preserveAspectRatio="none">
                                                        <path d="M12 5.45455H7.31455L10.6255 2.14364L9.85636 1.37455L6.54545 4.68545V0H5.45455V4.68545L2.14364 1.37455L1.37455 2.14364L4.68545 5.45455H0V6.54545H4.68545L1.37455 9.85636L2.14364 10.6255L5.45455 7.31455V12H6.54545V7.31455L9.85636 10.6255L10.6255 9.85636L7.31455 6.54545H12V5.45455Z" fill="currentColor"></path>
                                        ...
                                        <div className="margin-bottom margin-16px">
                                            <h2 data-w-id="a313081b-5ff0-9d58-ad3e-7267b0dcf915">
                                                Where You Can <span className="text-highlighted">Find Us</span>
                                            </h2>
                                        </div>
                                        <div className="location-header_para-wrap">
                                            <p data-w-id="a313081b-5ff0-9d58-ad3e-7267b0dcf91a" className="location-header_para">Visit our premier clinic in Adilabad for world-class dental, trauma, and implant care.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div data-w-id="7e5b3ff6-dcf4-ea28-b839-7d6dba310f08" className="location_list">
                        <div className="marquee_list">
                            <div className="marquee_item">
                                <div className="marquee-item_inner">
                                    <div className="locatioin_item">
                                        <div className="location_content">
                                            <div className="location_title">New York, NY</div>
                                            <p className="location_para">Tirumala Dental Clinic, Adilabad, Telangana 504001</p>
                                        </div>
                                        <div className="location_overlay"></div>
                                        <div className="location-image_wrap">
                                            <img src="assets/img/69e1254bc12dfcfe31c2c09e_location-image-1.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69e1254bc12dfcfe31c2c09e_location-image-1-p-500.webp 500w, assets/img/69e1254bc12dfcfe31c2c09e_location-image-1-p-800.webp 800w, assets/img/69e1254bc12dfcfe31c2c09e_location-image-1-p-1080.webp 1080w, assets/img/69e1254bc12dfcfe31c2c09e_location-image-1.webp 1140w" alt="Location image" className="location_image"/>
                                        </div>
                                    </div>
                                    <div className="locatioin_item">
                                        <div className="location_content">
                                            <div className="location_title">Los Angeles, CA</div>
                                            <p className="location_para">Tirumala Dental Clinic, Adilabad, Telangana 504001 </p>
                                        </div>
                                        <div className="location_overlay"></div>
                                        <div className="location-image_wrap">
                                            <img src="assets/img/69e1254b5bfb8519af35c271_location-image-2.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69e1254b5bfb8519af35c271_location-image-2-p-500.webp 500w, assets/img/69e1254b5bfb8519af35c271_location-image-2-p-800.webp 800w, assets/img/69e1254b5bfb8519af35c271_location-image-2-p-1080.webp 1080w, assets/img/69e1254b5bfb8519af35c271_location-image-2.webp 1140w" alt="Location image" className="location_image"/>
                                        </div>
                                    </div>
                                    <div className="locatioin_item">
                                        <div className="location_content">
                                            <div className="location_title">London, Uk</div>
                                            <p className="location_para">45 King’s Road, Chelsea,  SW3 5UZ</p>
                                        </div>
                                        <div className="location_overlay"></div>
                                        <div className="location-image_wrap">
                                            <img src="assets/img/69e1254a118093ebd39a1ec4_location-image-3.webp" loading="lazy" sizes="100vw" srcSet="assets/img/69e1254a118093ebd39a1ec4_location-image-3-p-500.webp 500w, assets/img/69e1254a118093ebd39a1ec4_location-image-3-p-800.webp 800w, assets/img/69e1254a118093ebd39a1ec4_location-image-3-p-1080.webp 1080w, assets/img/69e1254a118093ebd39a1ec4_location-image-3.webp 1140w" alt="Location image" className="location_image"/>
                                        </div>
                                    </div>
                                </div>
                                <div className="marquee-item_inner">
                            ...
                            <div id="w-node-_90aa065e-2d95-4aa8-f2ac-04b04859c2d0-4af74ce9" className="footer_menu">
                                <div className="footer-links-column">
                                    ...
                                    <div className="footer-menu_link-wrap">
                                        ...
                                        <a href="/about" aria-current="page" className="footer-menu_link w-inline-block w--current">
                                            <div>About</div>
                                        </a>
